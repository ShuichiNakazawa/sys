...
@include('common.errors')
    ...
    <div style="width: 90%; margin: 0 auto; text-align: center;">
        ...
        {{-- 出題画面 --}}
        <div v-bind:class="[isQuestionMode ? 'questionModeActive' : 'inactiveDiv']" style="border: solid 5px rgb(73, 172, 157); border-radius: 10px; margin: auto; width: 70%; background: white;">
            <div>
                {{-- 正誤履歴を表示するエリア --}}
                正誤履歴 表示エリア
            </div>
        ...
        {{-- 結果判定画面 --}}
        <div v-bind:class="[isResultMode ? 'resultModeActive' : 'inactiveDiv']" style="border: solid 5px rgb(73, 172, 157); border-radius: 10px; margin: auto; max-width: 70%; padding: 5px; background: white;">
            <div>
                <br>
