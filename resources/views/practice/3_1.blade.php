                ...
                <div class="list">
                    <div class="item">
                        <figure class="image">
                            ...
                            <img src="{{ asset('vue_images/01.jpg') }}" alt="">
                    ...
                    <div class="item">
                        <figure class="image">
                            <div class="status">SALE</div>
                            <img src="{{ asset('vue_images/02.jpg') }}" alt="">
                    ...
                    <div class="item">
                        <figure class="image">
                            <div class="status">SALE</div>
                            <img src="{{ asset('vue_images/03.jpg') }}" alt="">
                    ...
                    <div class="item">
                        <figure class="image">
                            <div class="status">SALE</div>
                            <img src="{{ asset('vue_images/04.jpg') }}" alt="">
                    ...
                    <div class="item">
                        <figure class="image">
                            ...
                            <img src="{{ asset('vue_images/05.jpg') }}" alt="">
                    ...
                    <div class="item">
                        <figure class="image">
                            <img src="{{ asset('vue_images/06.jpg') }}" alt="">
