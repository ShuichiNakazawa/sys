...
<html lang="ja">
  ...
  <body>
      ...
      <div class="container bg-dark text-white p-5">
        ...
        <form>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="form-check form-check-inlune">
                ...
                <div class="col-md-5">
                  <div class="fomr-check form-check-inline">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control" type="date" id="wedding_date" p;aceholder="日付をお選びください。">
              <small class="form-text">結婚式のお日にちを選択してください。</small>
            </div>
          </div>
          <!-- DVD仕上がり予定日 -->
          <div class="form-group row">
            <label class="col-md-3 col-form-label pt-0" for="delivery_date2">DVD仕上がり予定日
              <span class="badge badge-danger">必須</span>
            </label>
            <div class="col-md-9">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <div class="form-check mb-3">
                ...
                <small class="form-text">当社で曲を手配させていただく場合は、1曲あたり5,500円（税込）がかかります。</small>
              </div>
              <div class="form-check mb-3">
              ...
              <div class="form-check mb-3">
                ...
                <small class="form-text">当社でDVDの盤面をデザインさせていただく場合は、5,500円（税込）がかかります。</small>
              </div>
              <div class="form-row mb-3 align-items-center">
                ...
                <small class="form-text">プリントアウトした写真のスキャニングをご希望の肩は、１枚あたり550円にて承ります。</small>
              </div>
            </div>
          </div>
          <!-- 小計：オプション料金 -->
    ...
    <script src="main_5-2-1.js"></script>
  </body>
</html>